import axiosPackage, { AxiosRequestConfig, AxiosResponse, HttpStatusCode } from "axios";
...
export class AxiosHttpClient implements HttpClient {
    async request<Input, Output>(req: HttpRequest<Input>): Promise<Output | HttpErrorResponse> {
        ...
        const fullUrl = axios.defaults.baseURL?.endsWith('/') && req.url.startsWith('/')
